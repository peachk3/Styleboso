				...
				<div class="card mb-4">
					<div class="card-body">
						<form class="row g-3 needs-validation" action="/Styleboso/purchaseOrderAdd" method="post" novalidate>
							...
							<div class="col-md-6">
								<label for="validationCustom02" class="form-label">발주일자</label> 
									<input type="date" class="form-control" name="tran_date"
									id="validationCustom02" required>
								<div class="invalid-feedback">발주일자를 입력해주세요</div>
							</div>
							<div class="col-md-3">
								...
								<table class="table item-table text-left">
									<thead class="table-light">
										<tr>
											...
											<th scope="col" style="width:26%">수량</th>
										</tr>
									</thead>
									<tbody id="tableBody">
									</tbody>
...
<script type="text/javascript">
   ...
   document.addEventListener('DOMContentLoaded', function() {
	...
	function dataChangeJSON() {
		var tableRows = $('.item-table tbody tr'); 
	    var tableData = [];

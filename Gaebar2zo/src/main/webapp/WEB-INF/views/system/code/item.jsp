...
<body class="bg-gray-100 font-sans">
				...
				<div class="row align-items-center mb-4" style="padding: 10px;">
					...
					<div class="d-grid gap-2 d-md-flex justify-content-md-end"
						...
						<button class="btn btn-primary" type="button"
							onclick="insertItemCode()">등록</button>
						<button class="btn btn-primary"
							style="background-color: white; color: black;" type="button"
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<c:forEach var="item" items="${itemCodeList}">
							<c:if test="${fn:startsWith(groupCode, 'I')}">
								<tr>
									<td>
										<div class="form-check">
			...
			<form class="needs-validation" id="itemCodeForm" novalidate>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="close" id="itemCodeBtn"
					...
					<table class="table text-center mb-0">
						...
						<tbody>
							<tr>
								...
								<td id="s_cate_item_name" class="align-middle"
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary d-none"
							id="cancelButton" onclick="cancelEdit()">취소</button>
						...
						<button type="button" class="btn btn-success d-none"
							id="saveButton" onclick="saveItem()">저장</button>
					</div>
				</div>
			</form>
		</div>
	...
	<!-- 등록 상세&수정 모달 -->
	<div class="modal fade" id="insertItemModal" tabindex="-1"
		role="dialog" aria-labelledby="insertItemModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
				...
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title w-100 text-center"
							id="insertItemModalLabel">공통 품목코드 등록</h5>
						<button type="button" class="close" id="insertItemModalBtn"
							data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<table class="table text-center mb-0">
						...
						<tbody>
							<tr>
								<td><input type="text" id="new_s_cate_item_code"
									class="form-control" required> <span
									id="validationMessage"></span></td>
								<td><input type="text" id="new_s_cate_item_name"
									class="form-control" required> <span
									id="validationMessage"></span></td>
							</tr>
						</tbody>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary"
							onclick="saveNewItemCode()">저장</button>
					</div>
				</div>
			</form>
		</div>

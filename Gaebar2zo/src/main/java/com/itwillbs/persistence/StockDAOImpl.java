...
public class StockDAOImpl implements StockDAO {
	...
	public List<TransactionVO> reList(Criteria cri) throws Exception {
		...
		return sqlSession.selectList(NAMESPACE + "returnList", cri);
	}

	@Override
	public int getReturnTotalCount() throws Exception {
		logger.debug(" getReturnTotalCount() 실행 ");
		return sqlSession.selectOne(NAMESPACE + "returnTotalCount");
	}
	...
	public void updateTopTranNum(@Param("top_tran_nums") List<String> top_tran_nums) throws Exception {
		...
		sqlSession.update(NAMESPACE + "updateRETopTranNum", top_tran_nums);
	}
	...
	// 반품 상태 전환
	@Override
	public void updateRETopTranNum(List<String> top_tran_nums) throws Exception {

		logger.debug(" updateRETopTranNum(List<String> top_tran_nums) 실행");
	...
	@Override
	public void adjustReturnAdd_TopTranstatus(TransactionVO tvo) throws Exception {

		logger.debug("DAO : updateDetails() 호출");

		logger.debug("changetrvo : " + tvo);

		sqlSession.update(NAMESPACE + "adjustReturnAdd_TopTranstatus", tvo);
